...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      // add question text
      html += '<p class="jspsych-survey-multi-choice-text survey-multi-choice" style="font-weight:bold;">' + question.prompt 
      html += '</p>';
      ...
      for (var j = 0; j < question.options.length; j++) {
        ...
        html += '<div id="'+option_id_name+'" class="jspsych-survey-multi-choice-option" style="margin-top:-10px;">';
